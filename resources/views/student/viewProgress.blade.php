                ...
                <table class="mb-0 table">
                    ...
                    @foreach($chapters as $chap)
                        <tr>
                            ...
                            <td>
                                <a type="button" style="float:right; padding:5px; margin-left:5px;" href="/student/{{__($courseid)}}/progress/{{__($studentid)}}/viewChapterDetails/{{__($chap->id)}}" class="btn btn-info">View</a>
                            </td>
                        </tr>
                    @endforeach
                    </tbody>
                ...
                <table class="mb-0 table">
                    ...
                    @foreach($roundRobins as $rr)
                        <tr>
                            ...
                            <td>
                                <a type="button" style="float:right; padding:5px; margin-left:5px;" href="/student/{{__($rr->course_id)}}/{{__($rr->chapter_id)}}/{{__($rr->id)}}/ViewRR" class="btn btn-info">View</a>
                            </td>
                        </tr>
                    @endforeach
                    </tbody>
